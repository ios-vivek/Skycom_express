     ...
     @IBOutlet weak var nameField: UITextField!
        ...
        override func viewDidLoad() {
           ...
           let attributes = [
            ...
            nameField.attributedPlaceholder = NSAttributedString(string: "Name of receiver", attributes:attributes)
            ...
            addressField.attributedPlaceholder = NSAttributedString(string: "Address", attributes:attributes)
